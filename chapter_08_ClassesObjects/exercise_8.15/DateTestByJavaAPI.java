...
/* =====================================================================================
 *       Filename:  DateTestByJavaAPI.java
 *
 *    Description:  learning Java from book
                       P. Deitel H. Deitel "Java How to Program, 11/e (Early Objects)"
                          Polish Edition (chapters from 1 to 28)
                             Exercise 8.15 - test of Date objects using 
                                       java.time.LocalDate 
...
public class DateTestByJavaAPI {
   ...
   private static void modifyDay(Date date, int day, int expectedValue) {
      ...
      date.setDay(day);
      AssertTesting.compareDateJavaAPI(date, date.getMonth(), expectedValue, date.getYear());
      System.out.printf("-------Date's data: %s %n", date); 
   }
   ...
   private static void modifyMonth(Date date, int month, int expectedValue) {
      ...
      date.setMonth(month);
      AssertTesting.compareDateJavaAPI(date, expectedValue, date.getDay(), date.getYear());
      System.out.printf("-------Date's data: %s %n", date); 
   }
   ...
   private static void modifyYear(Date date, int year, int expectedValue) {
      ...
      date.setYear(year);
      AssertTesting.compareDateJavaAPI(date, date.getMonth(), date.getDay(), expectedValue);
      System.out.printf("-------Date's data: %s %n", date); 
   }
} 
