 ...
 *    Description:  learning Java from book
                       P. Deitel H. Deitel "Java How to Program, 11/e (Early Objects)"
                          Polish Edition (chapters from 1 to 28)
                             Exercise 8.15 - test of Date object's method nextDay
...
public class DateNextDayTest {
   ...
   public static void main(String[] args) {
      ...
      date.setDay(28);
      date.nextDay();
      System.out.printf("-------Test of leap year's date: %s %n", date.toStringMonthByLetters()); 
      AssertTesting.expectedResults(date, 2, 29, 2020);
      AssertTesting.compareDateJavaAPI(date, 2, 29, 2020);
      date.nextDay();
      System.out.printf("-------Test of leap year's date: %s %n", date.toStringMonthByLetters()); 
      AssertTesting.expectedResults(date, 3, 1, 2020);
      AssertTesting.compareDateJavaAPI(date, 3, 1, 2020);
