#!/bin/bash
# Executing should be OK only in system's structure with files-directories below:

java -ea -cp .:..:/home/mat/.m2/repository/javax/money/money-api/1.1/money-api-1.1.jar\
...
:/home/mat/.m2/repository/org/javamoney/moneta/moneta-convert/1.4/moneta-convert-1.4.jar \
 ConverterConsoleClient
