 ...
 *    Description:  learning Java from book
                       P. Deitel H. Deitel "Java How to Program, 11/e (Early Objects)"
                          Polish Edition (chapters from 1 to 28)
                             Exercise 6.37 - class of learning one-digit integers
...
public class ComputerAidedInstruction {
   ...
   public String getLastSummary() {
      ...
      if (correctAnswersRatio > 75) {
         summary = "Congratulations, go to next level.";
      }
      else {
         summary = "Ask the teacher to help in learning.";
      }
      summary += " Let another student to try";
   ...
   private void generateNextFactors() {
      ...
      } while(false == setNextQuestion(getRandomDigit(), getRandomDigit()));
   }
