 ...
 *    Description:  learning Java from book
                       P. Deitel H. Deitel "Java How to Program, 11/e (Early Objects)"
                          Polish Edition (chapters from 1 to 28)
                             Exercise 4.36 - checking that 3 entered integers by User
                                can create lengths of sides of triangle
...
public class SidesOfTriangle {
   ...
   public static void main(String[] args) {
      ...
      final String prompt = "To quit enter sequence other than integer. Enter integer as length of triangle's side number";
      final short numberOfTriangleSides = Triangle.getNumberOfTriangleSides();
      
      System.out.printf("*** This program checks that %d integers can representented lengths of sides of triangle%n", numberOfTriangleSides);
      ...
      while (true) {
         ...
         boolean result = triangle.isTriangleSidesLengths();
         triangle.printErrorsInfo();
         System.out.printf("*** Entered integers can%s representented lengths of sides of triangle%n", 
                                 result ? "" : " NOT");
