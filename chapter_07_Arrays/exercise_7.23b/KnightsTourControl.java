 ...
 *    Description:  learning Java from book
                       P. Deitel H. Deitel "Java How to Program, 11/e (Early Objects)"
                          Polish Edition (chapters from 1 to 28)
                             Exercise 7.23b - class of tracking while finding knight's
...
public class KnightsTourControl {
   ...
   public static final String START_INFO = String.format("%s %n %s%n", "Program was written in purpose of control test of tracking while ",
                                "finding knight's tour on virtual chessboard by random moves");
   ...
   public final static int RANDOM_1000_TOURS_KEY = 1000;
   ...
   private void make1000Tours() {
      ...
      for (int counter = 0; counter < 1000; counter++) {
         ...
         newSummary = generateKnightsTourSummary(true, true);
         KnightsTourSummary.insertSortByVisitedPositions(knightsTours1000Summaries, newSummary);
      }
   ...
   private boolean performMove(boolean printing) {
      byte moveNumber = RandomMoves.getNumberOfRandomPerformedMove(knightsTour);
   ...
   void printMenu() {
      ...
      System.out.printf("***** enter %d for try 1000 knight's tours starting with various positions %n", RANDOM_1000_TOURS_KEY);
